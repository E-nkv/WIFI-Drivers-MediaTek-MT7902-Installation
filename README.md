...
| **❌ FAILS** | **Fedora**, **Ubuntu**, and probably all other distros without the WEXT api| These versions have stripped the legacy wireless code from the kernel. The driver will fail to link. |
